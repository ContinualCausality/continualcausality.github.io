...
In this third edition of our bridge program, we aim to take further steps towards a unified treatment of these fields and continue to provide the space for learning, discussions, and to connect and build a diverse community. The activities range from traditional tutorials on the educational side and invited vision talks  to interactive sessions involving a speakers panel and community breakout discussions. All materials will be publicly disseminated as a foundation for the community, and the respectively discussed ideas, challenges and prospects will be aggregated to foster continued exchanges beyond AAAI-25.   
